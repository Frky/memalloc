...
/*
 * Fonction de formattage de l'affichage de la memoire libre
 */
...
/*
 * Fonction d'affichage de la memoire occupee
 */
void used()
{
	unsigned long i;
...
void help()
{
	...
	printf("\tsous la forme {adresse de depart, taille}\n");
		...
		switch(cmd) {
			...
			case ALLOC:
				...
				if (res == NULL) {
					...
					} else { /* pas de probleme, affichage de la zone allouee */
